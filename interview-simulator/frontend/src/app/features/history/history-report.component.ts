            ...
            <div class="relative w-40 h-40">
              <svg class="w-40 h-40 -rotate-90" viewBox="0 0 160 160">
                ...
                <circle cx="80" cy="80" r="70" stroke-width="10"
                        ...
                        [class]="scoreColor(iv.report.overallScore)"
                        [attr.stroke-dasharray]="circumference"
                        [attr.stroke-dashoffset]="circumference - (circumference * iv.report.overallScore / 100)" />
              </svg>
...
export class HistoryReportComponent implements OnInit {
  ...
  readonly interview = signal<StoredInterview | null>(null);
